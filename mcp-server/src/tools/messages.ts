...
import type { ToolDefinition, ExecutionContext, Message, ToolResult } from '../types.js';
...
export const messageTools: ToolDefinition[] = [
  {
    ...
    execute: async (args, _context): Promise<ToolResult> => {
      try {
        ...
        if (validatedArgs.dmConversationId) params.dmConversationId = validatedArgs.dmConversationId;
  ...
  },
  {
    ...
    execute: async (args, _context): Promise<ToolResult> => {
      try {
        ...
        return {
          content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Message deleted' }) }],
        };
      } catch (error: unknown) {
        const errorMessage = error instanceof Error ? error.message : 'Unknown error';
        return {
  ...
  },
  {
    ...
    execute: async (args, _context): Promise<ToolResult> => {
      try {
        ...
        return {
          content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Reaction added' }) }],
        };
      } catch (error: unknown) {
        const errorMessage = error instanceof Error ? error.message : 'Unknown error';
        return {
  ...
  },
  {
    ...
    execute: async (args, _context): Promise<ToolResult> => {
      try {
        ...
        return {
          content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Reaction removed' }) }],
        };
      } catch (error: unknown) {
        const errorMessage = error instanceof Error ? error.message : 'Unknown error';
        return {
