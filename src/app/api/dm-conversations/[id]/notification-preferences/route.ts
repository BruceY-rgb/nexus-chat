...
// Update DM notification preferences API
export async function PATCH(
  ...
  try {
    ...
    // Update DM member notification preferences
...
// Get DM notification preferences API
export async function GET(
  ...
  try {
    ...
    // Get DM member notification preferences
